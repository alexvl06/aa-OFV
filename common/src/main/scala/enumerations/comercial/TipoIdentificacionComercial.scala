...
object TipoIdentificacionComercial extends Enumeration {
  ...
  val CARNET_DIPLOMATICO = Val(0, "CARNET DIPLOMÁTICO", Some("D"), None)
  val CEDULA_CUIDADANIA = Val(1, "CÉDULA DE CIUDADANÍA", Some("C"), Some("C"))
  val CEDULA_EXTRANJERIA = Val(2, "CÉDULA DE EXTRANJERÍA", Some("E"), Some("E"))
  val CERTIFICADO_CONSTITUCION = Val(3, "CERTIFICADO DE CONSTITUCIÓN", Some("J"), None)
  ...
  val NUMERO_VISA = Val(8, "NÚMERO VISA", Some("V"), None)
  ...
  val REGISTRO_PUBLICO = Val(12, "REGISTRO PÚBLICO", Some("G"), None)
  val REGISTRO_PUBLICO_CONSTITUCION = Val(13, "REGISTRO PÚBLICO DE CONSTITUCIÓN", Some("U"), Some("X"))
