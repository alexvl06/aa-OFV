...
import co.com.alianza.persistence.entities.{ UltimaContrasena, UltimaContrasenaAgenteTable }
 ...
 */
case class UltimaContrasenaAgenteDAO()(implicit val dcConfig: DBConfig) extends TableQuery(new UltimaContrasenaAgenteTable(_)) with UltimaContrasenaDAOs {
