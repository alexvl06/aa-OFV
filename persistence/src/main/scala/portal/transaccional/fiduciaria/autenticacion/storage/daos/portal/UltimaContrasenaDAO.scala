...
import co.com.alianza.persistence.entities.{ UltimaContrasena, UltimaContrasenaTable }
 ...
 */
case class UltimaContrasenaDAO()(implicit val dcConfig: DBConfig) extends TableQuery(new UltimaContrasenaTable(_)) with UltimaContrasenaDAOs {
