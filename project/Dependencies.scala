...
object Dependencies {
	...
	private[Dependencies] object Compile {
		...
		val sprayCaching 					= "io.spray"           						  % "spray-caching"     		    % spray
		...
		val c3p0Lib 							= "c3p0"                					 	% "c3p0"                   		% c3p0
		val slickPGLib 						= "com.github.tminglei" 					 %% "slick-pg"              		% slickpg logScalaExclude
		val slickPG_jodaTimeLib 	= "com.github.tminglei" 					 %% "slick-pg_joda-time"    		% slickpgJodaTime logScalaExclude
	...
	val dbLibs: Seq[ModuleID] = Seq(postgresqlLib , c3p0Lib, ojdbcLib)
