...
object Versions {
  ...
  val akka: String               = "2.3.15" // No se puede actualizar mas ya que akka 2.4 necesita jdk 1.8
  ...
  val postgresql: String         = "9.3-1104-jdbc41"  // No se puede actualizar mas ya versiones superiores son para postgres 9.4
  val oracle: String             = "6"
  val h2: String                 = "1.4.191"
