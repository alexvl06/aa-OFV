...
object Versions {
  ...
  val ninbus: String              = "3.1"

  val specs2: String              = "3.7"
  val sprayTestkit: String        = "1.3.1"
  val spray: String               = "1.3.3"
  val sprayJson: String           = "1.3.2"
  val playJson: String            = "2.3.10"
  val restAssured: String         = "1.8.1"
  val ojdbc: String               = "6"
  val wsdl4j: String              = "1.4"
  val wss4j: String               = "1.5.12"
