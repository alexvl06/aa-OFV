...
case class PermisoTransaccionalUsuarioEmpresarialAgentes(
  permiso: Option[PermisoTransaccionalUsuarioEmpresarial],
...
case class PermisoAgente(idAgente: Int, tipoTransaccion: Int, minimoNumeroPersonas: Option[Int], tipoPermiso: Int, montoMaximoTransaccion: Option[Double],
  montoMaximoDiario: Option[Double], seleccionado: Boolean = false)

case class Permiso(permisoAgente: Option[PermisoAgente], autorizadores: Option[List[Autorizador]] = None)
