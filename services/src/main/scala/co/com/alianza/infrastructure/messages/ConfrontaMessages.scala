...
case class ObtenerCuestionarioRequestMessage(primerApellido:String, codigoTipoIdentificacion:Int, numeroIdentificacion: String, fechaExpedicion:String) extends MessageService {
}
...
case class ValidarCuestionarioRequestMessage(id:String, respuestas:Array[String],secuenciaCuestionario:Long,codigoCuestionario:Int) extends MessageService {
}
