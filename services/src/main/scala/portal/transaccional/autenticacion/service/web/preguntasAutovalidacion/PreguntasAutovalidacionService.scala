 ...
 */
case class PreguntasAutovalidacionService(preguntasValidacionRepository: PreguntasAutovalidacionRepository)(implicit val ec: ExecutionContext) extends CommonRESTFul with DomainJsonFormatters with CrossHeaders {
